...
// Returns best available surface format
static VkSurfaceFormatKHR GetBestSurfaceFormat(const vector<VkSurfaceFormatKHR>& availableFormats)
{
...
// Returns best available present mode
static VkPresentModeKHR GetBestPresentMode(const vector<VkPresentModeKHR>& availablePresentModes)
{
...
struct WindowDeviceInfo_T : public DeviceInfo
{
protected:
	// Window size
	...
	// Physical device surface format array
	vector<VkSurfaceFormatKHR> surfaceFormats;
	// Physical device present mode array
...
public:
	...
	// Returns vulkan surface instance
	const vector<const char*> GetExtensions() { return extensions; }
	...
	const VkSurfaceCapabilitiesKHR GetSurfaceCapabilities() { return surfaceCapabilities; }
	// Returns physical device surface format
	const VkSurfaceFormatKHR GetSurfaceFormat() { return surfaceFormat; }
	...
	const VkExtent2D GetSurfaceExtent() { return surfaceExtent; }
	...
	const vector<VkDeviceQueueCreateInfo> GetQueueCreateInfos()
	{
